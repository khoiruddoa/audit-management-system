                ...
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('perencanaan_audit_update',['id' => $perencanaan->id]) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jenis_audit"
                                            ...
                                            value="{{ old('jenis_audit', $perencanaan->jenis_audit) }}" autofocus>
                                        @error('jenis_audit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input
                                                ...
                                                value="terencana"
                                                @if(old('jenis_program_audit', $perencanaan->jenis_program_audit) == 'terencana') checked @endif>
                                        ...
                                        <div class="form-check">
                                            <input
                                                ...
                                                @if(old('jenis_program_audit', $perencanaan->jenis_program_audit) == 'tidak terencana') checked @endif>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input @error('tingkat_resiko') is-invalid @enderror"
                                                ...
                                                @if(old('tingkat_resiko', $perencanaan->tingkat_resiko) == 'low') checked @endif>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('tingkat_resiko') is-invalid @enderror"
                                                ...
                                                @if(old('tingkat_resiko', $perencanaan->tingkat_resiko) == 'medium') checked @endif>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('tingkat_resiko') is-invalid @enderror"
                                                ...
                                                @if(old('tingkat_resiko', $perencanaan->tingkat_resiko) == 'high') checked @endif>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="periode"
                                            ...
                                            value="{{ old('periode', $perencanaan->periode ) }}" autofocus>
                                        @error('periode')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="anggaran"
                                            ...
                                            value="{{ old('anggaran', $perencanaan->anggaran) }}" autofocus>
                                        @error('anggar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
