          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="{{route('perencanaan_audit_create')}}"
                    ...
                    <td>
                      ...
                      <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example"
                            ...
                            <option value="{{route('pelaksanaan_audit_detail', ['id' => $item->id])}}">Detail</option>
                            {{-- <option
                                value="">
                                Edit</option> --}}
                            <option
                                value="{{route('pelaksanaan_audit_edit', ['id' => $item->id])}}">
                                Edit</option>
                                <option
                                value="{{route('pelaksanaan_audit_status', ['id' => $item->id])}}">
                                Selesai</option>
                        </select>
                    </div>
