            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      @error('nip') is-invalid @enderror" id="nip" value="{{ old('nip') }}" autofocus>
                                    @error('nip')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" pattern="[a-zA-Z]+" title="Hanya huruf yang diperbolehkan" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name') }}" autofocus>
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" value="{{ old('jabatan') }}" autofocus>
                                    @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="hp" min="0" class="form-control @error('hp') is-invalid @enderror" id="hp" value="{{ old('hp') }}" autofocus>
                                    @error('hp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password" value="" autofocus>
                                    @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
