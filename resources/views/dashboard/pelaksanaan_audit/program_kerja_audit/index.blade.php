                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled class="form-control"
                                        value="{{ $audit->firstdate }} s/d {{ $audit->enddate }}">
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($program_kerja as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('program_kerja_audit_document', ['id' => $item->id]) }}"
                                                    class="btn btn-secondary"><i class="bi bi-collection"></i></a></td>



                                            <td><a href="{{ route('kertas_kerja_audit', ['id' => $item->id]) }}"
                                                    class="btn btn-secondary"><i class="bi bi-collection"></i></a></td>
                                            </td>
                                            <td>
                                                @if ($item->status == 1)
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('program_kerja_audit_detail', ['id' => $item->id]) }}">Detail</a>
                                                        </li>


                                                        <li><a class="dropdown-item"
                                                                href="{{ route('program_kerja_audit_edit', ['id' => $item->id]) }}">Edit</a>
                                                        </li>

                                                        <li><a class="dropdown-item"
                                                                href="{{ route('program_kerja_audit_delete', ['id' => $item->id]) }}">Hapus</a>
                                                        </li>
                                                        @if ($item->status == 1)
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('pelaksanaan_program_kerja_audit_cancel', ['id' => $item->id]) }}">Batal</a>
                                                            </li>
                                                        @else
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('pelaksanaan_program_kerja_audit_finish', ['id' => $item->id]) }}">Selesai</a>
                                                            </li>
                                                        @endif
