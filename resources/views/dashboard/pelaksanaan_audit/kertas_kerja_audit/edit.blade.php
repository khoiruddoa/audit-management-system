        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('kertas_kerja_audit',['id' => $program_kerja->id])}}">Kertas Kerja Audit</a></li>
                    <li class="breadcrumb-item active">Edit Kertas Kerja</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Kertas Kerja</h5>
                            ...
                            <form method="post" action="{{ route('kertas_kerja_audit_update',['id' => $kertas->id]) }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        value="{{ old('temuan', $kertas->temuan ) }}" autofocus>
                                    @error('temuan')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        value="{{ old('tanggal', $kertas->tanggal) }}" >
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <trix-editor input="y">{!!$kertas->kondisi!!}</trix-editor>
                                        @error('kondisi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-3" x-data="{ searchText: '', selectedRows: [] }">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <trix-editor input="z" x-html="selectedRows.join(', ')">{!!$kertas->kriteria!!}</trix-editor>
                                        @error('kriteria')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <trix-editor input="a">{!!$kertas->sebab!!}</trix-editor>
                                        @error('sebab')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <trix-editor input="b">{!!$kertas->rekomendasi!!}</trix-editor>
                                        @error('rekomendasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        value="{{ old('batas_waktu', $kertas->batas_waktu) }}">
                                    @error('batas_waktu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
